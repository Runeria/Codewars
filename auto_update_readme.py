...
REPO_NAME = 'Runeria/Codewars'

IMG_BASE_LINK = f'https://github.com/{REPO_NAME}/blob/master/assets/'
PROFILE = '![Codewars](https://www.codewars.com/users/Guimov/badges/large)'
